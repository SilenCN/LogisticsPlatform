...
function redictReleaseOrder() {
    if (null!=getCookie("userType")&&getCookie("userType")=="1"){
        document.location.href="releaseorder_.html";
    }else{
        document.location.href="releaseorder.html";
    }
}
function redictPersonInfo() {
    if (null!=getCookie("userType")&&getCookie("userType")=="1"){
        document.location.href="PersonalInfo_driver.html";
    }else{
        document.location.href="PersonalInfo_shipper.html";
    }
}
